...
describe('document', () => {
  describe('matchDocument', () => {
    const TEST_DOCUMENTS = [
      ...
      [{ request: {}, url: { hostname: 'muffin.fi', pathname: '' } }, false],
      [{ request: { mode: 'navigate' }, url: { hostname: 'muffin.fi', pathname: '' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'muffin.fi', pathname: '/#/swap' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'muffin.fi', pathname: '/asset.gif' } }, false],
